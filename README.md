...
<h1>Discord Web Auto Quest Extension</h1>
...
> [!IMPORTANT]
> **Server login is required** for the extension to function properly.

> [!NOTE]
> Join our Discord server for support: https://discord.gg/fdRbPfn4N
...
- 🖥️ Desktop streaming (STREAM_ON_DESKTOP)
...
- 🔐 Discord account with quests available
- ✅ Accepted quests on the quest-home page
- 🔑 Server login (required for extension to function)
